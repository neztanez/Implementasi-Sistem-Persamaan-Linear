#Nezta Misgi Febyandanu_21120122140156_Metode Numerik B_Tugas Implementasi Sistem Persamaan Linier
...
def main():
    ...
    print("1. Pakai Metode Matriks Balikan")
    print("2. Pakai Metode Dekomposisi LU Gauss")
    print("3. Pakai Metode Dekomposisi Crout")
